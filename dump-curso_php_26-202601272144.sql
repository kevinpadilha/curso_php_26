...
CREATE TABLE `estado` (
  ...
  `criado_em` timestamp NULL DEFAULT NULL,
  `atualizado_em` timestamp NULL DEFAULT NULL,
  `usuario_alteracao` timestamp NULL DEFAULT NULL,
...
INSERT INTO `usuario` VALUES (1,'Ariel'),(2,'Rafael'),(3,'Felipe'),(4,'Kevin'),(5,'Bruno'),(6,'Henrique Z'),(7,'Henrique'),(8,'Tiago'),(9,'Pedro');
...
-- Dump completed on 2026-01-27 21:45:01
